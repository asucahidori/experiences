	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
	    ...
	    return __webpack_require__(1).extendComponentView({
	        ...
	        render: function (bMapModel, ecModel, api) {
	            ...
	            // FIXME
	            // Moveend may be triggered by centerAndZoom method when
				// creating coordSys next time
				...
				// {style:'normal'};
	            var newMapStyle = {style:'midnight'};
	            // var newMapStyle = {style:'normal'};
	            ...
	            /*
				 * alert(boundary); var reg = new RegExp("\\[|\\]", "g");
				 * boundary = boundary.replace(reg, "");
				 */
	            if(storelng != null && storelng != ''){
	            	var myIcon = new BMap.Icon("../images/home_32px.png", new BMap.Size(32,32));
	            ...
	            if(boundary != null && boundary !=''){
	            	var barr = boundary.split(",");
					var points = new Array(); 
					for (var i = 0; i < barr.length; i += 2) {
						var lng = barr[i]; 
						var lat = barr[i + 1];
		    		...
		    		bmap.setViewport(polygon.getPath());
	            }
	        }
	    });
	}.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
