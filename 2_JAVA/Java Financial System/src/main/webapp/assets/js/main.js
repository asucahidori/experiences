...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", basePath+"/discovery/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", basePath+"/discovery/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				default:
					$(".navbar-brand img").attr("src", basePath+"/discovery/assets/images/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", basePath+"/discovery/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", basePath+"/discovery/assets/images/logo.png");
