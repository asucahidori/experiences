...
switch (curPage) {
    ...
    default :
        ...
        loc.index = extSub + './echarts';
        loc.feature = extSub + './echarts/doc';
        loc.example = extSub + './echarts/doc';
        loc.doc = extSub + './echarts/doc';
        loc.about = extSub + './echarts/doc';
        loc.changelog = extSub + './echarts/doc';
        loc.option = extSub + './echarts/doc';
        loc.spreadsheet = extSub + './echarts/doc';
        loc.start = extSub + './echarts/doc';
        loc.img = extSub + './echarts/doc';
        break;
}
