				...
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						<div id="report_1" class="row city_row">
							<div class="col-sm-3 city">
								...
								<div class="city_r">
									<span class="city_s1_building" id="gbCode"></span> <span
										class="city_s2">楼宇编码</span>
								</div>
							</div>
							<div class="col-sm-3 city">
								<div class="city_l">
								...
								<div class="city_r">
									<span class="city_s1" id="squareArea"></span> <span class="city_s2">建筑面积</span>
								</div>
							</div>
							<div class="col-sm-3 city">
								<div class="city_l">
									<i class="fa fa-building font_add"></i>
								</div>
								<div class="city_r">
									<span class="city_s1" id="households"></span> <span class="city_s2">住宅用户</span>
								</div>
							</div>

							<div class="col-sm-3 city">
								<div class="city_l">
									<i class="fa fa-automobile font_add"></i>
								</div>
								<div class="city_r">
									<span class="city_s1" id="house_park_num"></span> <span class="city_s2">停车位个数</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div
						...
						<div class="bj_main_r_cont" id="bj_main_r_cont">
							<div class="bj_main_r_cont_Report">
								<div id="communityUserCapacityByDate"
									class="bj_main_r_cont_Report_order1_build"></div>
								<!--report_user1结束-->
<!-- 								<div id="ConsumptionlevelByData" -->
<!-- 									class="bj_main_r_cont_Report_order2_build"></div> -->
								<!--report_user2结束-->
							</div>
							<!--report结束-->
							<br clear="all" />
							<div class="bj_main_r_cont_Report">
								<div id="communityUserOrderByDate"
									class="bj_main_r_cont_Report_build_order"></div>
								<!--report_order1结束-->
								<div id="communityConsumptionTopten"
									class="bj_main_r_cont_Report_build_top"></div>
								<!--report_order2结束-->
							</div>
							<!--report结束-->
							<br clear="all" />
							<div class="bj_main_r_cont_Report">
								<div id="FamilyStructure"
									class="bj_main_r_cont_Report_consumption_xiaoqu"></div>
								<!--report_order1结束-->
								<div id="ResidentialProperties" class="xiaoqu_none"></div>
								<!--report_order1结束-->
							</div>
							<!--report结束-->
							<br clear="all" />
	...
	<script>
		...
		getHouseholdProperty('${id}','buildingHomeProperty');
		initSumHouse('${id}', '${type}');
		initPopulation('${id}','${type}');
		//initPopulationDengji('${id}','${type}');
		initOrddetailTopten('${id}','${type}');
		initSumPopulation('${id}','${type}');
		getUsersCount('${id}', '${type}','${tinyVillageId}');
