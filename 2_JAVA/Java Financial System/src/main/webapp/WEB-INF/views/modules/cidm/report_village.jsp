						...
						<div class="container-fluid container-fullw bg-white">
							<div id="report_1" class="row city_row">
								<div class="col-sm-3 city">
                                    ...
                                    <div class="city_r">
                                    	<span class="city_s1_village" style="width:98%;letter-spacing:-2px;text-align:center;margin-left:1px;" id="gbCode"></span>
                                        <span class="city_s2">小区编码</span>
                                    </div>
								</div>
								<div class="col-sm-3 city">
                                    ...
                                    <div class="city_r">
                                        ...
                                        <span class="city_s2">建筑面积</span>
                                    </div>
								</div>
                                <div class="col-sm-3 city">
									<div class="city_l"><i class="fa fa-building font_add"></i></div>
                                    <div class="city_r">
                                    	<span class="city_s1" id="houseBldNum"></span>
                                        <span class="city_s2">楼宇数量</span>
                                    </div>
								</div>
						...
						<!-- start: map -->
                           ...
                           <div class="bj_main_r_cont" id="bj_main_r_cont">
                            <div class="bj_main_r_cont_Report">
                                <div id="communityUserCapacityByDate" class="village_user"></div><!--report_user1结束-->
                                <div id="ConsumptionlevelByData" class="village_grade" style="display:none"></div><!--report_user2结束-->	
<!--                                 <div id="communityUserOrderByArea" class="village_aa"></div> -->
                            </div><!--report结束--> <br clear="all"/>
                          <div class="bj_main_r_cont_Report">
                                <div id="communityUserOrderByDate" class="village_ordre"></div><!--report_order1结束-->
                                <div id="communityConsumptionTopten" class="village_top"></div><!--report_order2结束-->
                                <div id="FamilyStructure" class="village_structure" style="display:none"></div>
                            </div><!--report结束--> <br clear="all"/>
                                                 
                           <div id="housingPricesByDate" class="village_prices" style="display:none"></div><!--report_order1结束-->
                               <br clear="all"/>
                             <div class="bj_main_r_cont_Report">
                                <div id="ResidentialProperties" class="village_types" style="display:none"></div></div><!--report_order1结束-->
                            </div><!--report结束--> <br clear="all"/>
