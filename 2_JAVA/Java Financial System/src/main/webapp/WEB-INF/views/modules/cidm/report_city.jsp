...
<body>
				...
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						<div id="report_1" class="row city_row">
							<div class="col-sm-3 col-sm-12 city">
								<div class="city_l">
									<span class="glyphicon glyphicon-list-alt font_add"></span>
								</div>
								<div class="city_r">
									<span class="city_s1" id="gbCode"></span> <span class="city_s2">城市编码</span>
								</div>
							</div>
							<div class="col-sm-3 city">
								<div class="city_l">
									<i class="fa fa-pie-chart font_add"></i>
								</div>
								<div class="city_r">
									<span class="city_s1" id="squareArea"></span> <span class="city_s2">城市面积</span>
								</div>
							</div>
							<div class="col-sm-3 city">
								<div class="city_l">
								...
								<div class="city_r">
									<span class="city_s1" id="gdp"></span> <span class="city_s2">生产总值</span>
								</div>
							</div>

							<div class="col-sm-3 city">
								<div class="city_l">
									<i class="fa fa-group font_add"></i>
								</div>
								<div class="city_r">
									<span class="city_s1" id="sumPopulation"></span> <span class="city_s2">人口规模</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div
						...
						<div class="bj_main_r_cont" id="bj_main_r_cont">
							...
							<div id="communityUserCapacityByDate"
								class="bj_main_r_cont_Report_user1"></div>
							<!--report_user1结束-->
							<div id="communityUserOrderByDate"
								class="bj_main_r_cont_Report_order1"></div>
							<!--report_order1结束-->

							<br clear="all" />

							<div id="communityUserCapacityByArea"
								class="bj_main_r_cont_Report_user2"></div>
							<!--report_user2结束-->
							<br clear="all" />
							<div id="communityUserOrderByArea"
								class="bj_main_r_cont_Report_order2"></div>
							<!--report_order2结束-->
							<br clear="all" />

							<div id="income" class="bj_main_r_cont_Report_consumption1"></div>
							<!--report_order1结束-->
							<br clear="all" />

							<div id="housingPricesByDate"
								class="bj_main_r_cont_Report_residence2" style="display:none"></div>
							<!--report_order2结束-->
							<br clear="all" />
							<div id="housingPricesByArea"
								class="bj_main_r_cont_Report_residence1"></div>
							<!--report_order1结束-->
							<br clear="all" />
							<div id="sexStructure" class="bj_main_r_cont_Report_consumption2"></div>
							<!--report_order2结束-->
							<br clear="all" />
	...
	<script type="text/javascript"
		src="${ctxContents }/master/js/loadLinkageData.js"></script>
	...
	<script>
		...
		getChartSexData('${id}','countrysexcount','${type}');
		getAreaHomePriceByArea('${id}','cityHomePriceCountry','${type}');
		getAreaHomePriceByDate('${id}','cityHomePrice');
		//人均收入与支出报表
		loadIncomeExpenditure('${id}','${type}');
