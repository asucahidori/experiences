...
<style>
	...
	<body>
						...
						<div class="container-fluid container-fullw bg-white">
							<div id="report_1" class="row city_row">
								<div class="col-sm-3 city">
                                    ...
                                    <div class="city_r">
                                    	<span class="city_s1_street" id="gbCode"></span>
                                        <span class="city_s2">街道编码</span>
                                    </div>
								</div>
								...
								<div class="col-sm-3 city">
                                    ...
                                    <div class="city_r">
                                        ...
                                        <span class="city_s2">街道面积</span>
                                    </div>
								</div>
                                <div class="col-sm-3 city">
									<div class="city_l"><i class="fa fa-building font_add"></i></div>
                                    <div class="city_r">
                                    	<span class="city_s1" id="officeBldNum"></span>
                                        <span class="city_s2">写字楼</span>
                                    </div>
								</div>
						...
						<div class="container-fluid container-fullw padding-bottom-10 bj_main">
                           <div class="bj_main_r_cont" id="bj_main_r_cont">
                                ...
                                <div id="communityUserOrderByArea" class="bj_main_r_cont_Report_order2"></div><!--report_order2结束-->
								 ...
								 <!-- <div id="ResidentPopulationByArea" class="bj_main_r_cont_Report_consumption_jiedao bj_main_r_cont_Report_consumption_jiedao1"></div> -->
                           
 							    <div id="SurroundinTheFormats" class="bj_main_r_cont_Report_consumption_jiedao bj_main_r_cont_Report_consumption_jiedao2"></div>
                                <div id="FamilyStructure" class="jiedao_none"></div><!--report_order1结束-->
                                <!-- <div id="ConsumptionLevelByarea"  class="jiedao_none"></div> -->
                                
                                <!-- <div id="FamilyStructure" class="jiedao_none"></div>report_order1结束 -->
                           
                            <br clear="all"/>
                         
                                <div id="housingPricesByDate"  class="bj_main_r_cont_Report_zhuzhai1" style="display:none"></div><!--report_order1结束-->
                                <div id="housingPricesByArea" class="bj_main_r_cont_Report_zhuzhai2"></div><!--report_order2结束-->
                          <br clear="all"/>
                          
                                <div id="OfficeSpaceByArea"  class="bj_main_r_cont_Report_lou1"></div><!--report_order1结束-->
                                <div id="OfficeRentsByArea" class="bj_main_r_cont_Report_lou2"></div><!--report_order2结束-->
		...
		<script>
			...
			//initPopulation('${id}','${type}');
			initSumHouse('${id}','${type}');
			initSumPopulation('${id}','${type}');
			getAreaHomePriceByArea('${id}','townHomePriceVillage','${type}');
			getAreaHomePriceByDate('${id}','townHomePrice');
			//消费等级
			//loadResidentSalesLevelByArea('${id}','${type}');
			//常住人口
			//loadResidentPopulationByArea('${id}','${type}');
			
			getAreaVillageOffice('${id}','villageAreaCount');
